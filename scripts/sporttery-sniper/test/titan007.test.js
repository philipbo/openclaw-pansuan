...
const FINISHED_DETAIL_WITH_EVENT_SCORE_HTML = `
<html>
<head>
  <title>美国 VS 巴拉圭(2026赛季世界杯)-现场分析-新球体育-球探体育</title>
  <script>
    var scheduleID = 2906706;
    var state = -1;
    var strTime = '2026-06-13 09:00';
    var homeTeamName = '美国';
    var guestTeamName = '巴拉圭';
    var eventDetailData = "13^7^797^207172^0^1^1^0^1^0^^^^^^^!6^31^797^190115^138803^1^1^0^2^0^^^^^^^!6^45^797^190115^183522^1^1^5^3^0^^^^^^^!2^0^0^0^0^0^2^0^0^0^^^^^^^^^上半场结束！比分：3-0^^^^!6^73^776^176464^177826^0^3^0^3^1^^^^^^^!6^90^797^177398^0^1^3^8^4^1^^^^^^^";
  </script>
</head>
<body>
  <a class="LName">世界杯</a>
...
test("已完场详情页缺少比赛结束文案时从事件比分字段解析全场比分", () => {
  const detail = parseDetailHtml(FINISHED_DETAIL_WITH_EVENT_SCORE_HTML);

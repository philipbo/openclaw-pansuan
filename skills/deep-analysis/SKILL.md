...
🎯 推荐：
  ⚽ 胜平负：{主胜/平局/客胜}
  🏈 让球：{主队让X球 主胜/主队受让X球 客胜/...}（盘口：{X}）｜或 ⚠️ 观望（盘口过深/方向不明确）
...
- **胜平负**：必填，每场都有方向判断
- **让球**：基于亚盘分析，给出盘口和方向；如果盘口过深或方向不明确，标注「⚠️ 观望」并说明原因
- **大小球**：基于进球数分析，给出盘口和方向，附带泊松预期总进球数；方向不明确时标注「⚠️ 观望」
...
#### 综合评估
- 胜平负：{主胜/平局/客胜}
- 让球：{主队让X球 主胜/...}（盘口：{X}）｜或 ⚠️ 观望（原因）
- 大小球：{大X.5球/小X.5球}（盘口：{X.5}，预期总进球：{λ1+λ2}）｜或 ⚠️ 观望（原因）

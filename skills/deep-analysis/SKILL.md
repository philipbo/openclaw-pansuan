...
**输出格式**：明确指出三种赔率之间的一致性/矛盾点；若有矛盾**逐条列出具体矛盾项**。列出诱盘/RLM 在第 5～7 步的结论摘要。价值评估结论（哪个方向有价值/无价值）+ 与分析依据公司隐含概率的偏差分析（可选）。
...
- **矛盾**：各维度或各公司之间的冲突信号。**引用第 8 步已列出的具体矛盾项**（如欧指 vs 亚盘、某维与另两维共识不符），可按需要合并或精简为 1～2 句，不新发明未在第 8 步列出的矛盾。**大小球 vs 泊松比分**：第 8 步已根据第 4 步与第 7 步结论做一致性判断；若存在该矛盾，第 8 步会列入并在输出 1 的「核心矛盾」中体现，且输出 1 比分块须展示两套（整体 Top 6 + 与大小球同方向 Top 3）。本步直接引用第 8 步结论即可。若无则写「各维度方向一致，无明显矛盾」。
...
- **胜平负**：必填，**每场必填 2 项：首选、次选**。**结论中必须写出即时主/平/客赔率**（便于下单与复盘 CLV），可选带初盘一句。即时赔率取**本场欧指分析依据公司**的共识或代表性一家（欧洲 2 家、德国 3 家、亚洲 5 家，取一家展示或写「X 家共识约 主X.XX/平X.XX/客X.XX」）。
  ...
  - **次选**：在**与首选不同的两项**（主胜/平/客胜中剩二）中选一，**优先选与亚盘或大小球交叉后不矛盾、或更受支持的那一项**，并注明依据。例如：欧指主结论为「平」，亚盘主队受让平/半、分析出主+1 赢 → 主队不败，则次选可为「胜」（亚盘主+1 赢）；若亚盘更支持客队拿分则次选为「负」。若两项都与亚盘/大小球交叉后均合理，选赔率或概率更支持的一项并注明。**不得与首选相同**。
  - **格式**：首选一行、次选缩进一行，例如：
    ```
...
- **让球**：基于第 6 步亚盘分析，给出盘口和方向。**结论中必须写出即时盘口 + 主水/客水**，便于下单与复盘 CLV；可选带初盘一句。赔率依据从第 6 步亚盘分析中提炼。**以下情况须标「⚠️ 观望」并说明原因**：盘口过深（如深盘局方向难断）；方向不明确；**第 8 步标明该维度与欧指/大小球方向矛盾且未化解**时，注明「与欧指/大小球方向分歧，见核心矛盾」。
- **大小球**：基于第 7 步进球数分析，**先写大 X 球/小 X 球**（如大 2.5/3 球、小 2/2.5 球），再写预期总进球（λ1+λ2）。赔率依据从第 7 步进球数分析中提炼。**以下情况须标「⚠️ 观望」并说明原因**：方向不明确；**核心矛盾中包含「大小球 vs 泊松比分」**时，须注明「与泊松比分方向分歧，见核心矛盾」；**第 8 步标明该维度与欧指/亚盘方向矛盾且未化解**时，注明「与欧指/亚盘方向分歧，见核心矛盾」。

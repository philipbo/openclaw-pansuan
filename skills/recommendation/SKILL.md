...
🎯 推荐：
  ...
  📏 大小球：{大/小 X.5 球}（盘口：{X.5}，预期总进球：{λ1+λ2}）｜泊松 EV：{大球/小球 💰/❌/≈ 或 与泊松EV一致/分歧（若有）}｜或 ⚠️ 观望
...
- 大小球：**先写大 X 球/小 X 球**（如大 2.5/3 球、小 2/2.5 球），再写预期总进球；格式如「大{X.5}球」「小{X.5}球」（盘口：{X.5}，预期总进球：{λ1+λ2}）。若 deep-analysis 给出**泊松 EV**或「与泊松 EV 一致/分歧」，可带一句（如「泊松 EV 大球 💰」或「与泊松 EV 分歧」）供参考；方向不明确时标「⚠️ 观望」
- 比分：「比分 X:X」
...
| ---- | ------ | ---- | ------ | ---- | ------ | -------- | ------ | ---- | -------- |
| {主队} vs {客队} | {matchId} | {HH:MM} | {首选 / 次选} | {让X 上/下/观望} | {大/小X.5/观望} | {比分1} / {比分2} / {比分3} | {高/中/低} | {🔒/✅} | {理由} |
